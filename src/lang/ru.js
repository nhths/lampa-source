export default {
    ...
    settings_server_logs_title: 'Диагностика',
    settings_server_logs_show: 'Показать логи',
    settings_server_logs_show_descr: 'Открыть лог пробы capabilities устройства и жизненного цикла TorrServer',
    settings_server_logs_enabled: 'Собирать отладочные логи',
    settings_server_logs_enabled_descr: 'Держать ring-буфер логов включённым между сессиями — иначе в окне логов будет пусто',
    settings_server_logs_modal_title: 'Отладочный лог TorrServer',
    settings_server_logs_empty: 'Пока нет событий — включите «Собирать отладочные логи» и запустите торрент',
    settings_server_logs_refresh: 'Обновить',
    settings_server_logs_clear: 'Очистить',
    settings_server_logs_copy: 'Скопировать как JSON',
    settings_server_logs_copied: 'Скопировано в буфер',
    settings_server_logs_caption_caps: 'Проба caps',
    settings_server_logs_caption_lifecycle: 'Жизненный цикл TorrServer',
    settings_server_logs_filter_caps: 'Caps',
    settings_server_logs_filter_lifecycle: 'Lifecycle',

    torsserver_error_network: 'Не удаётся связаться с TorrServer',
    torsserver_error_timeout: 'TorrServer не ответил вовремя',
    torsserver_error_auth: 'TorrServer отклонил запрос (требуется авторизация)',
    torsserver_error_not_found: 'TorrServer вернул 404',
    torsserver_error_server: 'TorrServer вернул ошибку',
    torsserver_error_metadata: 'TorrServer загружает метаданные торрента — повторите через несколько секунд',
    torsserver_error_gst_off: 'GStreamer-конвейер отключён на TorrServer',
    torsserver_error_parse: 'TorrServer вернул некорректный ответ',
    torsserver_error_unknown: 'TorrServer недоступен',
    torsserver_error_details: 'Детали',
    torsserver_error_copy: 'Скопировать детали',
    torsserver_error_copied: 'Скопировано',
