export default {
    ...
    settings_server_logs_title: 'Diagnostics',
    settings_server_logs_show: 'Show logs',
    settings_server_logs_show_descr: 'Open the device-capability probe and TorrServer lifecycle log',
    settings_server_logs_enabled: 'Capture debug logs',
    settings_server_logs_enabled_descr: 'Keep ring-buffer logs enabled across sessions — required to see anything in the log viewer',
    settings_server_logs_modal_title: 'TorrServer debug log',
    settings_server_logs_empty: 'No events captured yet — toggle "Capture debug logs" and play a torrent',
    settings_server_logs_refresh: 'Refresh',
    settings_server_logs_clear: 'Clear',
    settings_server_logs_copy: 'Copy as JSON',
    settings_server_logs_copied: 'Copied to clipboard',
    settings_server_logs_caption_caps: 'Caps probe',
    settings_server_logs_caption_lifecycle: 'TorrServer lifecycle',
